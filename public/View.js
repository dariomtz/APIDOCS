 ...
 * 
 * All classes that extend View must implement the following methods:
 * 
...
class View extends Showable{
	 ...
	 * @param {Boolean} editable A boolean value that represents whether or not the logged in user has
	 * 							 authorization to edit this object.
